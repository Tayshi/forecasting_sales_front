...
with col_left:
    ...
    train_for_plot_forecast = pd.read_csv('forecasting_sales_front/data/train_14042022.csv')
    var_forecast = pd.read_csv('forecasting_sales_front/data/forecast.csv')

    to_plot = pd.read_csv('forecasting_sales_front/data/toplot.csv')
...
with col_right:
    ...
    # For forecast
    df_gr_1 = pd.read_csv('forecasting_sales_front/data/preprocessed_sales_grouped_1.csv')
    df_proportion = pd.read_csv('forecasting_sales_front/data/proportion_bread.csv', usecols=['item_sales'])

    df_to_plot_3 = pd.read_csv('forecasting_sales_front/data/toplot3.csv')
