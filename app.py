...
with expander_need_stock: #  Columns left - Needed product
    ...
    # too weight
    # def stackbarplot(df):
    #     fig = px.bar(df, y="family", x="family_sales", title="Prod à restock")
...
with expander_top_ten: # Column right - top10
    ...
    def barplot_top10(df):
        fig = px.bar(df, x=df.index, y='family_sales')
        fig.update_layout(paper_bgcolor='#B2B1B9')
        return fig
...
"data":
	[
	[11072.8170361491],[10096.702681488],
	[10818.2349870735],[10719.9567082622],[10111.4078738909],
	[11579.2257894392],[10933.771966097],[5717.8801360202],
	[9406.5785069372],[9646.6083757839],[11320.8531002457],
	[10022.4038210434],[10299.3880732539],[10281.1376238924],
	[10652.6678458757],[10266.0979969285],[9533.1830286846],
	[10697.3336648857],[10739.6512365489],[8176.5890603894]
	]}
    confidence_int ={
'6602.960957236907': 15542.673115061367,
'5626.846602575789': 14566.55876040025,
'6348.378908161257': 15288.091065985718,
'6250.10062934992': 15189.812787174382,
'5641.551794978621': 14581.26395280308,
'7109.3697105270085': 16049.08186835147,
'6463.915887184812': 15403.62804500927,
'1248.0240571079748': 10187.736214932436,
'4936.72242802496': 13876.43458584942,
'5176.752296871691': 14116.46445469607,
'6850.997021333551': 15790.70917915793,
'5552.547742131246': 14492.259899955625,
'5399.764680278498': 15199.011466229273,
'5381.514230917039': 15180.761016867813,
'5753.044452900291': 15552.291238851065,
'5366.474603953162': 15165.721389903936,
'4633.559635709262': 14432.806421660036,
'5797.710271910317': 15596.957057861091,
'5840.027843573505': 15639.27462952428,
'3276.965667413988': 13076.212453364762}
    ...
    train_store_1 = df_store_1.loc[mask_train]\
                                .loc[df_store_1['family' == 'BREAD/BAKERY']] # 2013 -> 2015
    test_store_1 = df_store_1.loc[df_store_1['date'].dt.year == 2016]\
                                .loc[df_store_1['family'] == 'BREAD/BAKERY'] # 2016 ->


    # extract key and value in confidence_int
    confidence_int_0 = []
    confidence_int_1 = []
    for key, value in confidence_int.items():
        confidence_int_0.append(key)
        confidence_int_1.append(value)


    # Plot with confidence interval
    # plot_forecast(forecast, train_store_1, test_store_1, confidence_int[:,0], confidence_int[:,1])
    plot_forecast(forecast, train_store_1, test_store_1, confidence_int_0, confidence_int_1)
