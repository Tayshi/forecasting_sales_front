...
check_code:
	@flake8 scripts/* forecasting_sales_front/*.py

black:
	@black scripts/* forecasting_sales_front/*.py
...
clean:
	...
	@rm -fr build dist
	@rm -fr forecasting_sales_front-*.dist-info
	@rm -fr forecasting_sales_front.egg-info
